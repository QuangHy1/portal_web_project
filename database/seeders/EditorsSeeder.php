    ...
    public function run(): void
    {
        ...
        DB::table('editors')->insert([
            [
                ...
                'avatar' => '9bspxsqEwPjhj4hja3bdmltccUKPRjKE8Zkk0tx7.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'avatar' => 'wztGjNEPoVS74dTRzGr4iulFRpcyTbYP6izFC3IT.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'avatar' => 'd8r9c29ExV6zcRz0Oks1oYftb5UXL1BQESFScC5e.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'avatar' => 'kly1cmB3JHGUIIvUXiI3kd5g7JAuIULWi8ePvZ4s.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'avatar' => 'XuZhPw9uc5b29gBo8Lib8idRKQvWOccqAHvNLEJC.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
