...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $hirings = Hiring::where('isFeatured', 'yes')->where('status', 'active')->inRandomOrder()->take(7)->get();
        $boosted = Hiring::where('isBoosted', 'yes')->where('status', 'active')->inRandomOrder()->take(1)->get();
        $hiringss = Hiring::where('isFeatured', 'yes')->where('status', 'active')->inRandomOrder()->take(8)->get();
