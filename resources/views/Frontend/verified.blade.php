...
@section('page_title')Xác Minh Email Thành Công(Employee)@endsection
                ...
                <form class="border p-3 rounded">
                    ...
                    <div class="sec_title position-relative text-center mt-4 mb-5">
                        ...
                        <h6 class="text-muted mt-3 mb-0">
                            ...
                            Bây giờ bạn có thể đăng nhập và bắt đầu tìm kiếm công việc phù hợp ngay hôm nay.
                        </h6>
                    </div>
                    <div class="form-group">
                        <a href="{{ route('employee.signin') }}" class="btn btn-md full-width theme-bg text-light fs-md ft-medium">
