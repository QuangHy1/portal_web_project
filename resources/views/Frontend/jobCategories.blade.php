    ...
    <div class="container">
        <div class="row">
            <div class="colxl-12 col-lg-12 col-md-12">
                <h1 class="ft-medium">Ngành Nghề</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="text-light">Home</a></li>
                        <li class="breadcrumb-item"><a href="#" class="text-light">Job</a></li>
                        <li class="breadcrumb-item active theme-cl" aria-current="page">Các Ngành Nghề</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row align-items-start mb-5">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="d-block full-width mt-2">
                    <h3 class="ft-medium mb-0">Danh sách tất cả Ngành Nghề</h3>
                </div>
            </div>
