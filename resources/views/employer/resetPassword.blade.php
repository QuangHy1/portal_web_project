...
@section('page_title')Reset Employer Password @endsection
                ...
                <div class="colxl-12 col-lg-12 col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('employer.signin') }}">Đăng Nhập</a></li>
        ...
        <div class="container">
            <div class="row align-items-start justify-content-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <form class="border p-3 rounded" method="POST" action="{{ route('employer.reset.password.submit') }}">
                        @csrf
                    ...
                    <div class="mt-3 text-center">
                        <p>Bạn đã nhớ mật khẩu? <a href="{{ route('employer.signin') }}">Đăng Nhập Ngay</a></p>
                    </div>
                </div>
            </div>
        </div>
