...
@section('page_title')OTP Employer Password @endsection
        ...
        <div class="container">
            <div class="row align-items-start justify-content-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <form method="POST" action="{{ route('employer.otp.verify') }}" class="border p-3 rounded text-center">
                        @csrf
                        ...
                        <div class="mt-3">
                            <a href="{{ route('employer.recover') }}">← Gửi lại mã</a>
                        </div>
                    </form>
                </div>
            </div>
