        ...
        <div class="dashboard-tlbar d-block mb-5">
            <div class="row">
                <div class="colxl-12 col-lg-12 col-md-12">
                    <h1 class="ft-medium">Hi {{ Auth::guard('employee')->user()->employee->lastname }}, <span id="greeting"></span> !</h1>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-info rounded">
                        ...
                        <p class="p-0 m-0 text-light fs-md">Tin Đã Apply</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-success rounded">
                        ...
                        <p class="p-0 m-0 text-light fs-md">Tin Đã Duyệt</p>
                        <i class="lni lni-checkmark-circle"></i>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-primary rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">{{ $rejectedJobs }}</h2>
                        <p class="p-0 m-0 text-light fs-md">Tin Đã Từ Chối</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-purple rounded">
                        ...
                        <p class="p-0 m-0 text-light fs-md">Tin Đã Lưu</p>
