									...
									<tbody>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="mainTitle">
                                                <h2 class="text" style="color:#000;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:28px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0">Hi "{{ $company_name }}"</h2>
                                            </td>
                                        </tr>
										<tr>
													...
													<tbody>
														<tr>
															<td style="padding-bottom: 20px;" align="center" valign="top" class="description">
																<p class="text" style="color:#666;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;text-align:center;padding:0;margin:0">Chúng tôi hiểu rằng việc quên mật khẩu có thể gây khó chịu, nhưng đừng lo lắng - chúng tôi ở đây để giúp bạn!

                                                                    Để lấy lại tài khoản của bạn trên JobScout, vui lòng đặt lại mật khẩu bằng liên kết và nút bên dưới:</p>
															</td>
														</tr>
													</tbody>
												</table>
									...
									<tbody>
										...
										<tr>
											<td style="padding: 0px 10px 10px;" align="center" valign="top" class="footerEmailInfo">
												<p class="text" style="color:#bbb;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0">Nếu có bất kỳ câu hỏi nào, vui lòng liên hệ với chúng tôi <a href="#" style="color:#bbb;text-decoration:underline" target="_blank">huy.lq.63cntt@ntu.edu.vn</a>
											</td>
										</tr>
										<tr>
											<td style="font-size:1px;line-height:1px" height="30">&nbsp;</td>
