...
<head>
    ...
    <title>Từ chối duyệt Acc Employer</title>
</head>
<body>
    ...
    <tr>
        <td style="padding-right:10px;padding-left:10px;" align="center" valign="top" id="bodyCell">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableCard" style="background-color:#fff;border:1px solid #e5e5e5; border-bottom-width:1px;">
                ...
                <tr>
                    <td style="padding: 0 20px;" align="center" valign="top" class="containtTable">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription">
                            <tbody>
                            <tr>
                                <td style="padding-bottom: 20px;" align="center" valign="top" class="description">
                                    <div style="color:#333; font-family:'Open Sans',Helvetica,Arial,sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center;">
                                        {!! $body !!}
                                    </div>
                                </td>
                            </tr>
