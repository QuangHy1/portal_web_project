...
{{--                <a href="#" class="nav-icon pe-md-0" data-bs-toggle="dropdown">--}}
{{--                    @if ($loggedInAdminProfile && $loggedInAdminProfile->avatar)--}}
{{--                        <img src="{{ asset('uploads/admin_profile/' . $loggedInAdminProfile->avatar) }}" class="avatar img-fluid rounded-circle" alt="Admin Avatar" style="width: 50px; height: 50px;border: 3px solid #fbffff; box-shadow: 0 0 15px #00fbff;">--}}
{{--                    @else--}}
{{--                        <img src="{{ asset('login/img/user_ava.jpg') }}" class="avatar img-fluid rounded-circle" alt="Default Avatar">--}}
{{--                    @endif--}}
{{--                </a>--}}
                <div class="dropdown-menu dropdown-menu-end rounded">
                    <a href="#" class="dropdown-item"> {{--{{ route('admin.profile.index') }}--}}
                        <span>Hồ sơ</span>
