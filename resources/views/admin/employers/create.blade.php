...
@section('custom_css')
    <link rel="stylesheet" href="{{ asset('admin/css/employers/create.css') }}">
@endsection
    ...
    <div class="container">
        ...
        <form action="{{ route('admin.employers.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_monday" name="hours_monday" value="{{ old('hours_monday') }}">
                @error('hours_monday')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_tuesday" name="hours_tuesday" value="{{ old('hours_tuesday') }}">
                @error('hours_tuesday')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_wednesday" name="hours_wednesday" value="{{ old('hours_wednesday') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_thursday" name="hours_thursday" value="{{ old('hours_thursday') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_friday" name="hours_friday" value="{{ old('hours_friday') }}">
                @error('hours_friday')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_saturday" name="hours_saturday" value="{{ old('hours_saturday') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hours_sunday" name="hours_sunday" value="{{ old('hours_sunday') }}">
                @error('hours_sunday')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="isverified" name="isverified" required>
                    ...
                    <option value="1" {{ old('isverified') == 1 ? 'selected' : '' }}>Có</option>
                    <option value="0" {{ old('isverified') == 0 ? 'selected' : '' }}>Không</option>
                </select>
                @error('isverified')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="isSuspended" name="isSuspended" required>
                    ...
                    <option value="no" {{ old('isSuspended') == 'no' ? 'selected' : '' }}>Không</option>
                    <option value="yes" {{ old('isSuspended') == 'yes' ? 'selected' : '' }}>Có</option>
                </select>
                @error('isSuspended')
                <div class="text-danger">{{ $message }}</div>
                @enderror
