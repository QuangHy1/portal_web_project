            ...
            <div class="colxl-12 col-lg-12 col-md-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="theme-cl">Quản Lý Tin</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="dashed-list-full bg-white rounded p-3 mb-3">
                                ...
                                <div class="dashed-list-last">
                                    <div class="text-left">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#cover{{ $application->id }}" class="btn gray ft-medium apply-btn fs-sm rounded mr-1"><i class="lni lni-add-files mr-1"></i>Xem Lời Nhắn</a>
